                ...
                <ul class="flex flex-col w-full justify-start items-center gap-5">
                    ...
                    <ul class="flex flex-col w-full justify-start items-center gap-5">
                        ...
                        <li><a href="kelas.php" class="text-white my-5 shadow-lg text-center rounded-lg py-1">data
                                kelas</a></li>
                        <li><a href="spp.php" class="text-white my-5 shadow-lg text-center rounded-lg py-1">
                                spp siswa</a></li>
                        <li><a href="history_pembayaran.php"
                                class="text-white my-5 shadow-lg text-center rounded-lg py-1">history
                                pembayaran</a></li>
                    </ul>
            </div>
