...
<body>
    ...
    <div class="w-full flex justify-end">
        <div class="flex w-full flex-wrap h-52 justify-center items-center mr-5 gap-5">
            <div
                ...
                <h1 class="font-bold text-start w-full px-5 pb-5 text-xl text-slate-200">pembayaran</h1>
                <a href="pembayaran.php"
                    class="flex items-center gap-2 bg-blue-900/50 w-28 h-8 rounded-lg justify-center">mulai<svg
            ...
            <div
                ...
                <h1 class="font-bold text-start w-full px-5 pb-5 text-xl text-slate-200">history</h1>
                <a href="history.php"
